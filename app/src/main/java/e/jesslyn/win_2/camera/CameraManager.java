...
public final class CameraManager {
    ...
    private static e.jesslyn.win_2.camera.CameraManager sCameraManager;
     ...
     */
    private final e.jesslyn.win_2.camera.PreviewCallback mPreviewCallback;
    ...
    public static void init(Context context) {
        if (sCameraManager == null) {
            sCameraManager = new e.jesslyn.win_2.camera.CameraManager(context);
        }
    }
     ...
     */
    public static e.jesslyn.win_2.camera.CameraManager get() {
        return sCameraManager;
    }

    private CameraManager(Context context) {
        this.mConfigManager = new e.jesslyn.win_2.camera.CameraConfigurationManager(context);
        mPreviewCallback = new e.jesslyn.win_2.camera.PreviewCallback(mConfigManager);
