...
import e.jesslyn.win_2.utils.ScreenUtils;
...
public final class QrCodeFinderView extends RelativeLayout {
    ...
    public QrCodeFinderView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMaskColor = resources.getColor(e.jesslyn.win_2.R.color.qr_code_finder_mask);
        mFrameColor = resources.getColor(e.jesslyn.win_2.R.color.qr_code_finder_frame);
        mLaserColor = resources.getColor(e.jesslyn.win_2.R.color.qr_code_finder_laser);
        mTextColor = resources.getColor(e.jesslyn.win_2.R.color.qr_code_white);
    ...
    private void init(Context context) {
        ...
        RelativeLayout relativeLayout = (RelativeLayout) inflater.inflate(e.jesslyn.win_2.R.layout.layout_qr_code_scanner, this);
        FrameLayout frameLayout = (FrameLayout) relativeLayout.findViewById(e.jesslyn.win_2.R.id.qr_code_fl_scanner);
        mFrameRect = new Rect();
    ...
    private void drawText(Canvas canvas, Rect rect) {
        ...
        mPaint.setTextSize(getResources().getDimension(e.jesslyn.win_2.R.dimen.text_size_13sp));
        String text = getResources().getString(e.jesslyn.win_2.R.string.qr_code_auto_scan_notification);
